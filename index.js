...
app.get("/rest/getAlbumList2.view", async(req, res) => {
    ...
    let albums = await (await fetch(`${config.music}/getall/albums?start=${offset || '0'}&limit=${size || '50'}&sortby=${type === "alphabeticalByName" ? "title&reverse=" : "created_date&reverse=1"}`)).json();
